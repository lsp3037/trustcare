              ...
              <div className="border border-zinc-900 divide-y divide-zinc-900 bg-zinc-950 text-xs">
                ...
                {orderServices.map((item, idx) => (
                  <div key={`serv-${idx}`} className="p-3 flex justify-between gap-4">
                    <span className="text-zinc-450">{item.service_name} <span className="text-[9px] text-zinc-600 ml-1">x{item.quantidade}</span></span>
                ...
                {orderItems.map((item, idx) => (
                  <div key={`prod-${idx}`} className="p-3 flex justify-between gap-4">
                    <span className="text-zinc-450">{item.product_name} <span className="text-[9px] text-zinc-600 ml-1">x{item.quantity}</span></span>
